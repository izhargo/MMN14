...
typedef enum errors {NONE,WRONG_COMMAND,WRONG_INPUT_IN_LABEL,SYMBOL_ALREADY_IN_THE_TABLE,LABEL_INPUT_TOO_LONG,WRONG_INSTRUCTION_NAME, WRONG_PARAMETER_VALUE,WRONG_MATRIX_SIZE,WRONG_MATRIX_PARAMETER_VALUE,NO_LABEL_FOR_MATRIX, WRONG_OPERAND_INPUT,TOO_MANY_OPERANDS,TOO_FEW_OPERANDS,NO_LABEL_FOR_EXTERN_INSTRUCTION,ERROR_IN_LABEL_FOR_EXTERN_INSTRUCTION,LABEL_INPUT_NOT_EXSIST,WRONG_INPUT_VALUE} errorType;
